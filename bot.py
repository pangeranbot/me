...
cl = LINETCR.LINE()
cl.login(token="Em2wpUJ3kBKQCYVaY4U3.Pz6w5kOuMtjjeJIJGEqo8W.AhSs4S0H6fO7dV+R5JD3RxtE2ec/DQTC/w3O5KMxnGE=")
cl.loginResult()
...
admin=["u0b57006bd3ce6aec2975f70aba64f1e8","ua59e96e4aa149932491238a381e40ef3"]
wait = {
    'contact':False,
    'autoJoin':True,
     ...
     for zx in range(0,100):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto  Like By @Akang QIR \n👇\n👇\n👇")
            #-----------------------------[JANGAN DIEDIT - Hargai Saya]-----------------------------#
